...
<?php
    if(isset($_POST['submitBtn']))
    {
        ...
        $query = "INSERT INTO tbl_khenneth (firstName, lastName, birthDate, address, gender, departmentId) 
        VALUES ('$firstName', '$lastName', '$birthDate', '$address', '$gender', '$departmentName')";
